...
$(document).ready(function(){
    $("#form-edit").submit(function(e){
            ...
            var ubah_foto  = $('#ubah_foto').prop('checked') == true ? '1':'0';
            ...
            formData.append('ubah_foto', ubah_foto);

            swal({
                    title: 'Konfirmasi Rubah Data User !',
                ...
                if (result.value) {
                      $.ajax({
                        url: "<?php echo AJAXURL."/ajax_edit_user.php";?>",
                        type: "post",
                        data: formData,
                        cache: false,
                        processData: false,
                        ...
                        success: function(result) {
                            ...
                            if (hasil.hasil !== "sukses") {
                                ...
                                setTimeout(function () { 
                                        swal({
                                            title: 'Data User Berhasil di Rubah',
