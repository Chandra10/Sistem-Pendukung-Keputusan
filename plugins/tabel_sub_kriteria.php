...
<script type="text/javascript">
    ...
    var tabel = $('#tabel-sub_kriteria').DataTable({
            "bprocessing": false,
            "serverSide": false,
            "bAutoWidth": false,
            "order":[[0, "asc"]],
            "ajax":{
                url : "<?php echo AJAXURL.'/ajax_tabel_sub_kriteria.php';?>",
                type: "post",
                dataType: 'json',
   ...
   $(document).on('click', '.hapus_data', function(){
    ...
    $.ajax({
        type: 'POST',
        url: "<?php echo AJAXURL."/ajax_hapus_sub_kriteria.php";?>",
        data: {no:no},
        ...
        setTimeout(function () { 
                swal({
                    ...
                    type    : 'success',
                    text    : 'Anda Telah menghapus Data sub_kriteria',
                    timer: 3000,
