...
<script type="text/javascript">
    ...
    var tabel = $('#tabel-supplier').DataTable({
            "bprocessing": false,
            "serverSide": false,
            "bAutoWidth": false,
            "order":[[0, "desc"]],
            "ajax":{
                url : "<?php echo AJAXURL.'/ajax_tabel_supplier.php';?>",
                type: "post",
                dataType: 'json',
            ...
            "columns" :[
                {"data" : "id_supplier","visible": false},
   ...
   $(document).on('click', '.hapus_data', function(){
    ...
    $.ajax({
        type: 'POST',
        url: "<?php echo AJAXURL."/ajax_hapus_supplier.php";?>",
        data: {no:no},
        ...
        setTimeout(function () { 
                swal({
                    ...
                    type    : 'success',
                    text    : 'Anda Telah menghapus Data supplier',
                    timer: 3000,
