...
<script type="text/javascript">
    ...
    var tabel = $('#tabel-kriteria').DataTable({
            "bprocessing": false,
            "serverSide": false,
            "bAutoWidth": false,
            "order":[[0, "asc"]],
            "ajax":{
                url : "<?php echo AJAXURL.'/ajax_tabel_kriteria.php';?>",
                type: "post",
                dataType: 'json',
            ...
            "columns" :[
                {"data" : "id_kriteria","visible": false},
   ...
   $(document).on('click', '.hapus_data', function(){
    ...
    $.ajax({
        type: 'POST',
        url: "<?php echo AJAXURL."/ajax_hapus_kriteria.php";?>",
        data: {no:no},
        ...
        setTimeout(function () { 
                swal({
                    ...
                    type    : 'success',
                    text    : 'Anda Telah menghapus Data kriteria',
                    timer: 3000,
