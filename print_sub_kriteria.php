...
<body>
	<div align="center">
	    ...
	    <hr size="10000px">
	    <font style="font-size: 15px;" align="center">Laporan Data Sub Kriteria</font>
		<hr size="10000px">
		<table style="font-size: 10px; border-collapse: collapse; border: 1px;" class="tdth" width="100%" border="1" cellspacing="0">
			...
			<tbody>
				<?php
				$sql="SELECT a.*, b.* from tb_sub_kriteria a JOIN tb_kriteria b
				...
				while ($datakriteria=mysqli_fetch_array($query)) {
					...
					echo  "
						<tr>
							...
							<td style='padding: 5px;'>".$datakriteria['nilai_sub_kriteria']."</td>
							<td style='padding: 5px;'>".$datakriteria['sifat_sub_kriteria']."</td>
						</tr>
						";
				}
				?>
