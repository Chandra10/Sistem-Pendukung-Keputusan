<?php
include "koneksi.php";
$page1="edit_nilai_supplier";

$no = null;
    if (isset($_GET["no"])) {
        $no = $_GET["no"];
    }
        $sql    = "SELECT * FROM tb_nilai_supplier where id_nilai_supplier = '".$no."' ";
...
<div class="card card-info">
    <div class="card-header">
        <h5 class="card-title"><i class="fa fa-child"></i> Edit Data Nilai Supplier</h5>
    ...
    <div class="card-body">
        ...
        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data" id="form-edit">
            ...
            <div class="row">
                <div class="col-sm-6">
                     <input type="hidden" name="id_nilai_supplier" id="id_nilai_supplier" value="<?php echo $result['id_nilai_supplier'] ;?>">
                                    ...
                                    <select class="form-control-sm form-control" name="id_supplier_nilai" id="id_supplier_nilai">
                                        ...
                                        <?php
                                          ...
                                          while($data=mysqli_fetch_array($hasil)){
                                             echo "<option value='".$data["id_supplier"]."' ".(($result["id_supplier_nilai"]== $data["id_supplier"])?"selected='selected'":"").">".$data['nama_supplier']."</option>";
                                          }
                                        ?>
                                    </select>
                                </td>
                                ...
                                <td>
                                    <select class="form-control-sm form-control" name="kecepatan_pengiriman" id="kecepatan_pengiriman">
                                        ...
                                        <?php
                                          ...
                                          $hasil = mysqli_query($con,$query);
                                          while($data=mysqli_fetch_array($hasil)){
                                              echo "<option value='".$data["nilai_sub_kriteria"]."' ".(($result["kecepatan_pengiriman"]== $data["nilai_sub_kriteria"])?"selected='selected'":"").">".$data['nilai_sub_kriteria']."</option>";
                                          }
                                        ?>
                                    </select>
                                </td>
                                ...
                                <td>
                                    <select class="form-control-sm form-control" name="tingkat_diskon" id="tingkat_diskon">
                                        ...
                                        <?php
                                          ...
                                          $hasil = mysqli_query($con,$query);
                                          while($data=mysqli_fetch_array($hasil)){
                                              echo "<option value='".$data["nilai_sub_kriteria"]."' ".(($result["tingkat_diskon"]== $data["nilai_sub_kriteria"])?"selected='selected'":"").">".$data['nilai_sub_kriteria']."</option>";
                                          }
                                        ?>
                                    </select>
                                </td>
                                ...
                                <td>
                                    <select class="form-control-sm form-control" name="pelayanan" id="pelayanan">
                                        ...
                                        <?php
                                          ...
                                          $hasil = mysqli_query($con,$query);
                                          while($data=mysqli_fetch_array($hasil)){
                                              echo "<option value='".$data["nilai_sub_kriteria"]."' ".(($result["pelayanan"]== $data["nilai_sub_kriteria"])?"selected='selected'":"").">".$data['nilai_sub_kriteria']."</option>";
                                          }
                                        ?>
                                    </select>
                                </td>
                                ...
                                <td>
                                    <select class="form-control-sm form-control" name="garansi" id="garansi">
                                        ...
                                        <?php
                                          ...
                                          $hasil = mysqli_query($con,$query);
                                          while($data=mysqli_fetch_array($hasil)){
                                              echo "<option value='".$data["nilai_sub_kriteria"]."' ".(($result["garansi"]== $data["nilai_sub_kriteria"])?"selected='selected'":"").">".$data['nilai_sub_kriteria']."</option>";
                                          }
                                        ?>
                                    </select>
                                </td>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderles">
                                ...
                                <td>
                                    <select class="form-control-sm form-control" name="keaslian_barang" id="keaslian_barang">
                                        ...
                                        <?php
                                          ...
                                          $hasil = mysqli_query($con,$query);
                                          while($data=mysqli_fetch_array($hasil)){
                                              echo "<option value='".$data["nilai_sub_kriteria"]."' ".(($result["keaslian_barang"]== $data["nilai_sub_kriteria"])?"selected='selected'":"").">".$data['nilai_sub_kriteria']."</option>";
                                          }
                                        ?>
                                    </select>
                                </td>
                                ...
                                <td>
                                    <select class="form-control-sm form-control" name="tempo_pembayaran" id="tempo_pembayaran">
                                        ...
                                        <?php
                                          ...
                                          $hasil = mysqli_query($con,$query);
                                          while($data=mysqli_fetch_array($hasil)){
                                              echo "<option value='".$data["nilai_sub_kriteria"]."' ".(($result["tempo_pembayaran"]== $data["nilai_sub_kriteria"])?"selected='selected'":"").">".$data['nilai_sub_kriteria']."</option>";
                                          }
                                        ?>
                                    </select>
                                </td>
                                ...
                                <td>
                                    <select class="form-control-sm form-control" name="bisa_dikembalikan" id="bisa_dikembalikan">
                                        ...
                                        <?php
                                          ...
                                          $hasil = mysqli_query($con,$query);
                                          while($data=mysqli_fetch_array($hasil)){
                                              echo "<option value='".$data["nilai_sub_kriteria"]."' ".(($result["bisa_dikembalikan"]== $data["nilai_sub_kriteria"])?"selected='selected'":"").">".$data['nilai_sub_kriteria']."</option>";
                                          }
                                        ?>
                                    </select>
                                </td>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="tanggal_nilai" id="tanggal_nilai" class="form-control form-control-sm" value="<?php echo $result['tanggal_nilai'] ;?>" disabled = "true">
