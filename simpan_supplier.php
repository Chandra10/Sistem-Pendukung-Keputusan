...
<div class="card card-info">
    <div class="card-header">
        <h5 class="card-title"><i class="fa fa-child"></i> New Data supplier</h5>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderles">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="nama_supplier" id="nama_supplier" class="form-control form-control-sm">
                            ...
                            <tr>
                                ...
                                <td style="width: 5px;">:</td>
                                <td><input type="text" name="telepon" id="telepon" class="form-control form-control-sm">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td><input type="text" name="alamat" id="alamat" class="form-control form-control-sm">
