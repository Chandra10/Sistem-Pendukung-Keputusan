...
<body>
	<div align="center">
	    ...
	    <hr size="10000px">
	    <font style="font-size: 15px;" align="center">Laporan Data Supplier</font>
		<hr size="10000px">
		<table style="font-size: 10px; border-collapse: collapse; border: 1px;" class="tdth" width="100%" border="1" cellspacing="0">
			...
			<tbody>
				...
				while ($dataPelanggan=mysqli_fetch_array($query)) {
					$no++;
					echo  "
						<tr>
							<td style='text-align:center; font-size: 10px; padding: 10px;'>$no</td>
							<td style='padding: 5px;'>".$dataPelanggan['nama_supplier']."</td>
							<td style='padding: 5px;'>".$dataPelanggan['telepon']."</td>
							<td style='padding: 5px;'>".$dataPelanggan['alamat']."</td>
						</tr>
						";
				}
				?>
